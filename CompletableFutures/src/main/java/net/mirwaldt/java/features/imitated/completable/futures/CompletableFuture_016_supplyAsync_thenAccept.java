...
public class CompletableFuture_016_supplyAsync_thenAccept {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        Future<String> supplySyncFuture = commonPool.submit(stringSupplier::get);
        Future<?> thenAcceptFuture = commonPool.submit(() -> {
            String supplySyncResult = callUnchecked(() -> supplySyncFuture.get());
            printlnConsumer.accept(supplySyncResult);
        });
